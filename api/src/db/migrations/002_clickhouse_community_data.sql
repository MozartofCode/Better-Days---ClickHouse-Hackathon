-- Community/demand data reporting store. Populated only by
-- src/modules/community-data/etl/syncClickhouse.ts from the Postgres
-- operational tables (truncate + reload).
